<template>
    <div class="app-container">
        ...
        <StandardTable table-key="merchant-menu-manage" v-if="refreshTable" v-loading="loading" :data="rows" row-key="menuId" :default-expand-all="isExpandAll" :tree-props="{ children: 'children' }" size="small">
